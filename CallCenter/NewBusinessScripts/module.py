...
connection = pypyodbc.connect("Driver={SQL Server Native Client 11.0}; Server=(localdb)\MSSQLLocalDB; Database=aspnet-CallCenter-20180320051047; Trusted_Connection=yes;") 
