...
SQLCommand_active = """ SELECT [Id], [ClientReference], [ClientID], [Name], [AssignAmount], [TotalReceived], [OtherDue], [TotalDue], [Desk], [Status], FORMAT([PalacementDate],'yyyy-MM-dd'), FORMAT([LastWorkDate],'yyyy-MM-dd HH:MM:ss') FROM [dbo].[WorkPlatformModels] WHERE ClientID = '%s' AND Status = 'OPEN' ORDER BY PalacementDate DESC"""

SQLCommand_closed = """ SELECT [Id], [ClientReference], [ClientID], [Name], [AssignAmount], [TotalReceived], [OtherDue], [TotalDue], [Desk], [Status], FORMAT([PalacementDate],'yyyy-MM-dd'), FORMAT([LastWorkDate],'yyyy-MM-dd HH:MM:ss') FROM [dbo].[WorkPlatformModels] WHERE ClientID = '%s' AND Status = 'CLOSED' ORDER BY PalacementDate DESC"""

SQLCommand_pending = """ SELECT [Id], [ClientReference], [ClientID], [Name], [AssignAmount], [TotalReceived], [OtherDue], [TotalDue], [Desk], [Status], FORMAT([PalacementDate],'yyyy-MM-dd'), FORMAT([LastWorkDate],'yyyy-MM-dd HH:MM:ss') FROM [dbo].[WorkPlatformModels] WHERE ClientID = '%s' AND Status = 'PENDING' ORDER BY PalacementDate DESC"""

SQLCommand_hold = """ SELECT [Id], [ClientReference], [ClientID], [Name], [AssignAmount], [TotalReceived], [OtherDue], [TotalDue], [Desk], [Status], FORMAT([PalacementDate],'yyyy-MM-dd'), FORMAT([LastWorkDate],'yyyy-MM-dd HH:MM:ss') FROM [dbo].[WorkPlatformModels] WHERE ClientID = '%s' AND Status = 'HOLD' ORDER BY PalacementDate DESC"""
...
workbook = xlsxwriter.Workbook('C:\\Users\\Sergiu\\source\\repos\\CallCenter\\CallCenter\\ReportingFolder\\Recovery_Rerpot.xlsx')
