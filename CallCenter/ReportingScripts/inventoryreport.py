...
SQLCommand = """ SELECT [Id], [ClientReference], [ClientID], [Name], [AssignAmount], [TotalReceived], [OtherDue], [TotalDue], [Desk], [Status], FORMAT([PalacementDate],'yyyy-MM-dd'), FORMAT([LastWorkDate],'yyyy-MM-dd HH:MM:ss') FROM [dbo].[WorkPlatformModels] WHERE ClientID = '%s' ORDER BY PalacementDate DESC"""
...
workbook = xlsxwriter.Workbook('C:\\Users\\Sergiu\\source\\repos\\CallCenter\\CallCenter\\ReportingFolder\\Inventory_Rerpot.xlsx')
